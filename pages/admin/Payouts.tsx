...
import { CheckCircle, XCircle, Clock, Search, Filter, AlertTriangle } from 'lucide-react';
...
const AdminPayouts: React.FC = () => {
  ...
  const handleAction = async () => {
      ...
      const status = confirmAction.type === 'approve' ? PayoutStatus.PROCESSED : PayoutStatus.REJECTED;
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-in fade-in">
              <div className="bg-white rounded-lg w-full max-w-sm p-6 shadow-xl">
                  <div className="flex items-center gap-4 mb-4">
                      <div className={`p-3 rounded-full ${confirmAction.type === 'approve' ? 'bg-green-100 text-green-600' : 'bg-red-100 text-red-600'}`}>
                  ...
                  <div className="flex justify-end gap-3">
                      ...
                      <button 
                          ...
                          className={`px-4 py-2 text-sm font-bold text-white rounded-lg transition-colors ${confirmAction.type === 'approve' ? 'bg-green-600 hover:bg-green-700' : 'bg-red-600 hover:bg-red-700'}`}
                      >
                          Confirm
                      </button>
                  </div>
